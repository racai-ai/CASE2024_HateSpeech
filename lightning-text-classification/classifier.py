...
class permute_tensor(nn.Module):
    def forward(self,x):
...
class Classifier(pl.LightningModule):
    ...
    def __build_model(self) -> None:
        ...
        self.classification_head = nn.Sequential(
            #print_tensor(),
            #nn.LSTM(self.encoder_features, self.encoder_features, num_layers=1, bidirectional=True, batch_first=True),
            #extract_tensor(),
            #nn.Tanh(),
            #nn.Dropout(0.3),
            #nn.Linear(self.encoder_features*2, self.encoder_features * 2),
            #nn.Tanh(),
            #nn.Dropout(0.3),
            ...
            #print_tensor(),
            #nn.Linear(1020, self.encoder_features),
    ...
    def forward(self, tokens, lengths):
        ...
        return {"logits": self.classification_head(word_embeddings)}

    def f1_loss(self, y_pred_logits, y_true):
    ...
    def loss(self, predictions: dict, targets: dict) -> torch.tensor:
        ...
        #return self.f1_loss(predictions["logits"], targets["labels"])
